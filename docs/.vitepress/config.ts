...
export default defineConfig({
  ...
  themeConfig: {
    ...
    sidebar: {
      '/': [
        ...
        },
        {
          text: 'API Reference',
          items: [
            { text: 'Documentação Completa', link: '/api/' }
          ]
        }
      ]
    },
    ...
    editLink: {
      pattern: 'https://github.com/seu-usuario/sdk-tinyerp/edit/main/docs/:path',
  ...
  head: [
    ...
    ['meta', { name: 'og:title', content: 'SDK TinyERP - SDK não oficial para API v2' }],
    ['meta', { name: 'og:description', content: 'SDK não oficial em TypeScript para a API v2 do TinyERP (Olist). Totalmente tipado, zero dependências.' }]
  ],
